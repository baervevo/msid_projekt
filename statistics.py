...
from constants import NUMERICAL, CATEGORICAL, PERCENTILE, FEATURE, FEATURE_TYPE, MEDIAN, MEAN, STANDARD_DEVIATION, MINIMUM, MAXIMUM, MISSING_VALUES, UNIQUE_CLASSES, CLASS_PROPORTIONS, DEFAULT_DATASET_PATH
...
def main():
    ...
    save_to_csv(statistics, 'statistics.csv')
